...
const Navbar = () => {
  ...
  return (
      <div className="header  p-6 md:p-0 lg:pt-10 flex items-center relative justify-between">
              ...
              {/* responsive menu */}
              <div className={`${menuOpen ? "translate-x-0" : "translate-x-full"} md:hidden lg:hidden bg-white/5 backdrop-blur-md h-screen w-[70%] absolute top-0 right-0 px-8 transform transition-transform duration-500 ease-in-out  `}>
              ...
              <ol className="bg-white/5 backdrop-blur-md hidden sm:flex  Text-Preset-8 md:text-[12px] lg:text-[14px] space-x-5 lg:space-x-10 px-[38.5px] lg:px-[64px]  justify-end items-center w-full sm:w-[90%] md:w-[80%] lg:w-[50%] z-10 whiteTextColor">
                <li>
                  <Link href="/"
                className={`py-[38.5px] hover:border-b-2 hover:border-white ${pathName === "/" ? "border-b-2 border-white" : ""}`}
                  ><span className='font-bold pr-2.5'>00</span>
                    HOME</Link>
                </li>
                <li>
                  <Link href="/DESTINATION"
                   className={`py-[38.5px] hover:border-b-2 hover:border-white  ${pathName === "/DESTINATION" ? "border-b-2 border-white" : ""}`}><span className='font-bold pr-2.5'>01</span>
                    DESTINATION</Link>
                </li>
                <li>
                  <Link href="/TECHNOLOGY" 
                  className={`py-[38.5px] hover:border-b-2 hover:border-white  ${pathName === "/TECHNOLOGY" ? "border-b-2 border-white" : ""}`}>
                    <span className='font-bold pr-2.5'>02</span>TECHNOLOGY</Link>
                </li>
                <li className='py-[38.5px]'>
                  <Link href="/CREW" 
                  className={`py-[38.5px] hover:border-b-2 hover:border-white  ${pathName === "/CREW" ? "border-b-2 border-white  " : ""}`}><span className='font-bold pr-2.5'>03</span>
                    CREW</Link>
                </li>
              </ol>
            </div>
